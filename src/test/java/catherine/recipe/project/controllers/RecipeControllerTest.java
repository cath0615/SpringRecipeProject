...
public class RecipeControllerTest {
    ...
    public void testPostNewRecipeForm() throws Exception {
        ...
        //pass in the post method to mimic a form post, set a parameter of ID and an empty string
        mockMvc.perform(post("/recipe")
                        .contentType(MediaType.APPLICATION_FORM_URLENCODED)
                .param("id", "")
                .param("description", "some string")
        )
                //we expect back a url and a status of 300
                .andExpect(status().is3xxRedirection())
                //2 comes from the mock at line 66
    ...
    public void testDeleteAction() throws Exception{
        ...
        mockMvc.perform(get("/recipe/1/delete"))
                //expect to get a redirect back
                .andExpect(status().is3xxRedirection())
                //expect to get redirect back to the root
