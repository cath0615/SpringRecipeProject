package catherine.recipe.project.bootstrap;

import catherine.recipe.project.domain.Recipe;
import catherine.recipe.project.domain.*;
...
@Component
//this bootstrap class sets up the object graph
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    //it will take in an iterable (e.g. a list) and save enerything coming out of the repositories
    //and see if everything works on that (we save a list of recipes to the recipe repository)
